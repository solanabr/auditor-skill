...
### Step 4.4 — Known Attack Vectors (all in-scope, KV-001..120)

```
ACTIONS:

  1. Read known-vectors/INDEX.md
  2. Read every file known-vectors/001-*.md through known-vectors/120-*.md
...
Fill in:
  ...
  - Known vector results (KV-001 through KV-120, each in-scope one with verdict)
